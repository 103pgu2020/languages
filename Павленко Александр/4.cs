    ...
    class Program
    {
        ...
        point_2:
            ...
            while (!Console.KeyAvailable)
            {
                ms++;
                Thread.Sleep(15);
                if (ms == 100) { s++; ms = 0; Console.SetCursorPosition(43, 10); Console.WriteLine("{0:00}", s); }
                if (s == 60) { m++; s = 0; Console.SetCursorPosition(40, 10); Console.WriteLine("{0:00}:{1:00}", m, s); }
